          ...
          >
            ...
            <div className="mt-12 max-w-2xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12">
              <p className="text-lg text-white/80 leading-relaxed">
                The Name Analysis module will help you uncover the hidden vibrations in your name,
                discover auspicious spellings, and understand how your name aligns with your destiny grid.
              </p>
