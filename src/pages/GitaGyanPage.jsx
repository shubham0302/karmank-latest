          ...
          >
            ...
            <div className="mt-12 max-w-2xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12">
              <p className="text-lg text-white/80 leading-relaxed">
                The Gita Gyan module will bring you the timeless wisdom of the Bhagavad Gita,
                mapped to modern decisions and aligned with your unique numerological signatures.
              </p>
              <p className="mt-6 text-white/60">
                This profound tool is currently under development and will be available soon.
              </p>
            </div>
          </motion.div>
        </div>
