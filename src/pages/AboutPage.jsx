            ...
            <div className="relative w-full mb-12 overflow-hidden rounded-xl border border-cyan-500/20 bg-gradient-to-b from-cyan-950/40 via-gray-950 to-black p-12">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                  ...
                  <strong className="text-cyan-300">Vedic Ank Shashtra</strong>{" "}
                  — an elegant blend of ancient numerological wisdom and cosmic
                  technology
                </p>
              </div>
            </div>
            ...
            <article className="group relative rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-2xl overflow-hidden transition-all duration-500 hover:border-cyan-400/50 hover:shadow-[0_0_50px_-12px_rgba(34,211,238,0.3)] mb-8">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 leading-relaxed text-lg">
                  KarmAnk stands for{" "}
                  <em className="text-cyan-300 not-italic font-serif text-xl">
                    Karma × Ank (Numbers)
                  </em>{" "}
                  — your energetic blueprint captured through numbers. We
                  provide numerology reports, life-path analyses, compatibility
                  assessments, and karmic cycle forecasts — each generated using{" "}
                  <span className="text-cyan-300">Vedic Ank Shashtra</span>{" "}
                  principles and refined by modern algorithmic tools.
                </p>
              </div>
            </article>
          </ScrollReveal>
              ...
              <div className="relative z-10">
                ...
                <ol className="relative border-l-2 border-cyan-500/30 ml-4 space-y-12">
                  {[
                    {
                      title: "Collect",
                      desc: "You provide basic inputs like name and date of birth (and optional time/place).",
                    },
                    {
                      title: "Compute",
                      desc: "Our engine applies Vedic Ank Shashtra algorithms to convert inputs into numerological patterns.",
                    },
                    {
                      title: "Interpret",
                      desc: "AI-assisted interpretation translates numerical maps into clear, personalised narratives.",
                    },
                    {
                      title: "Deliver",
                      desc: "Instant, beautifully formatted digital reports you can save, share, or revisit anytime.",
                    },
                  ].map((step, idx) => (
                    <li key={idx} className="ml-8 relative group/step">
                      ...
                      <h3 className="font-semibold text-cyan-100 text-xl mb-2 flex items-center gap-2">
                        ...
                        <ChevronRight
                          size={16}
                          className="opacity-0 group-hover/step:opacity-100 transition-opacity text-cyan-500"
                        />
                      </h3>
                  ...
                  {[
                    {
                      ...
                      desc: "Built on the authentic teachings of Vedic Ank Shashtra — not random numerology.",
                    },
                    {
                      title: "Modern Accuracy",
                      desc: "Advanced algorithms ensure precision and remove the errors of manual calculation.",
                    },
                    {
                      title: "AI-Assisted Insights",
                      desc: "AI helps convert numbers into readable, practical guidance while preserving spiritual context.",
                    },
                    {
                      title: "Comprehensive Compatibility",
                      desc: "Analysis extends across relationship types — romantic, familial, professional, and more.",
                    },
                  ].map((item, idx) => (
                    <div key={idx} className="space-y-3">
                      ...
                      <p className="text-gray-300 leading-relaxed pl-5 border-l border-white/10">
                        {item.desc}
                      </p>
                    </div>
                  ))}
              ...
              <div className="relative z-10">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-white/90">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex items-center gap-3 text-gray-300 text-lg p-3 rounded-xl hover:bg-white/5 transition-colors"
                    >
          ...
          <ScrollReveal delay={1000}>
            <article className="group relative rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-2xl overflow-hidden transition-all duration-500 hover:border-cyan-400/50 hover:shadow-[0_0_50px_-12px_rgba(34,211,238,0.3)] mb-8">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 leading-relaxed text-lg">
                  KarmAnk treats your data with utmost care. Inputs are used
                  only to generate your readings and for product improvement. We
                  follow industry-standard security practices and a
                  privacy-first design philosophy — see our{" "}
                  <a
                    href="/privacy"
                    target="_blank"
