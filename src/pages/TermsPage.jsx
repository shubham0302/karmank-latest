            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-amber-100/80 text-sm leading-relaxed">
                  By accessing or using KarmAnk™, you acknowledge that you have
                  read, understood, and agree to be legally bound by these Terms
                  & Conditions. KarmAnk™ provides interpretative numerological
                  insights based on Vedic Ank Shashtra. These are not
                  scientifically validated predictions. Please read carefully
                  before proceeding.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-900/60 backdrop-blur-md rounded-xl border border-cyan-500/20 shadow-2xl p-8">
            ...
            <div className="mb-8 rounded-xl border border-cyan-500/20 bg-cyan-900/10 p-5 backdrop-blur-xl">
              ...
              <nav className="grid gap-2 text-sm text-cyan-100/70">
                ...
                <a href="#ip" className="hover:text-cyan-300 transition-colors">
            ...
            <div className="space-y-10 leading-relaxed text-white/80">
              ...
              <section id="acceptance">
                ...
                <p>
                  By accessing or using KarmAnk ("we", "us", "our", "Platform"),
              ...
              <section id="definitions">
                ...
                <p>
                  <strong>"KarmAnk"</strong> refers to the application and
                  website providing numerology-based insights built on Vedic Ank
                  Shashtra.
                </p>
                <p>
                  <strong>"Services"</strong> include numerology readings,
                  vibration analyses, compatibility reports, forecasts, and all
                  related digital outputs.
                </p>
                <p>
                ...
                <p>
                  <strong>"Content"</strong> includes interpretations, scores,
                  insights, charts, visuals, and all generated material.
                </p>
              </section>
              ...
              <section id="eligibility">
                ...
                <p>
                  ...
                  parental/guardian consent to use this platform. By using the
                  service, you confirm you have the legal capacity to enter this
                  agreement.
                </p>
              </section>
              ...
              <section id="accounts">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    All activity conducted under your account is your
                    responsibility.
                  </li>
                  <li>
                    You must notify us of any unauthorized access immediately.
                  </li>
                  <li>
              ...
              <section id="use">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    You agree not to misuse the platform, reverse engineer,
                    disrupt, or exploit the system.
                  </li>
                  <li>
                    You must not use KarmAnk for harmful, illegal, defamatory,
                    or fraudulent activities.
                  </li>
                  <li>
                    You may not copy, reproduce, or redistribute any generated
              ...
              <section id="license">
                ...
                <p>
                  ...
                  license to use KarmAnk for personal purposes. This license
                  does not permit:
                </p>
              ...
              <section id="payments">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Paid features, digital reports, and subscriptions are billed
                    through secure third-party processors.
                  </li>
                  <li>
                    All purchases of digital goods are final once delivered.
                  </li>
                  <li>
                    Subscription renewals are automatic unless cancelled prior
                    to the billing date.
                  </li>
                  <li>
                    Failure to use the service does not entitle the user to a
                    refund.
                  </li>
                </ul>
              </section>
              ...
              <section id="content">
                <h2 className="text-xl font-semibold mb-3 text-cyan-300">
                  Interpretative Nature of Content
                </h2>
                <p>
                  KarmAnk provides insights rooted in{" "}
                  <strong>Vedic Ank Shashtra</strong>. These readings are
                  interpretative, symbolic, and spiritual in nature. They are
                  not scientifically validated predictions or guarantees.
                </p>
                <p className="mt-2">
                  The user is solely responsible for decisions made using the
                  content and should seek professional advice for legal,
                  medical, financial, or psychological matters.
                </p>
              </section>
              ...
              <section id="ip">
                ...
                <p>
                  All platform content — including algorithms, UI, text,
                  graphics, and generated insights — is the exclusive property
                  of KarmAnk. Unauthorized reproduction, distribution,
                  modification, or resale is strictly prohibited.
                </p>
              </section>
              ...
              <section id="thirdparty">
                ...
                <p>
                  KarmAnk may contain links or integrations with third-party
              ...
              <section id="disclaimer">
                ...
                <p>
                  ...
                  accuracy, reliability, completeness, or uninterrupted access.
                  No information provided constitutes professional advice of any
                  kind.
                </p>
              </section>
              ...
              <section id="liability">
                ...
                <p>
                  To the fullest extent permitted by Indian law, KarmAnk shall
                  not be liable for any direct, indirect, incidental,
                  consequential, punitive, or special damages including loss of
                  profits, emotional distress, data loss, business interruption,
              ...
              <section id="indemnity">
                ...
                <p>
                  You agree to indemnify and hold harmless KarmAnk, its
                  founders, employees, affiliates, and partners from any claims,
                  damages, liabilities, losses, or expenses resulting from:
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <section id="termination">
                ...
                <p>
                  We may suspend, limit, or terminate access at any time for
                  violations, abuse, fraudulent behaviour, or any activity
              ...
              <section id="changes">
                ...
                <p>
                  We may modify or update these Terms at any time. Continued use
                  of KarmAnk after changes indicates acceptance of the revised
                  terms.
                </p>
              </section>
              ...
              <section id="misc">
                ...
                <p>
                  ...
                  remaining provisions remain in effect. These Terms, together
                  with the Privacy Policy and Disclaimer, constitute the entire
                  agreement between you and KarmAnk.
                </p>
              </section>
