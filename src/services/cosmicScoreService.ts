...
const MESSAGES: Record<string, string[]> = {
  excellent: [
    'The cosmos is fully aligned in your favour today. Act boldly — the universe is backing you.',
    'Rare planetary harmony today. Take your most important step forward.',
    'Exceptional energy flows through all domains. Trust your instincts completely.',
  ],
  good: [
    'Strong cosmic tailwinds today. Focus on your priorities and you will achieve much.',
    'Favourable planetary energies support your goals. Stay grounded and take action.',
    'Mostly auspicious patterns today. Lead with your strengths.',
  ],
  moderate: [
    'Mixed cosmic energies today. Discern carefully before major decisions.',
    'Planetary patterns call for balance. Work with your strongest domain.',
    'Some friction in the cosmic field today — use it as a catalyst for growth.',
  ],
  challenging: [
    'Challenging transits today invite introspection and patience. Rest is sacred.',
    'The cosmos suggests caution. Avoid major decisions; focus on planning.',
    'A day for inner work and preparation. What you sow in silence blooms later.',
  ],
};

function pickMessage(quality: string, date: Date): string {
...
export function calculateCosmicReport(
  ...
  return {
    ...
    domains,
    todayMessage: pickMessage(quality, date),
